#!/usr/bin/env python3
"""
d133 -- d102 re-run against the converged plant-class constant of d131.

Identical to d102 in every other respect; only DERIVED changes (0.306034 -> 0.307831), because the
earlier value was an Euler minimiser quoted to six digits.  d102 stays in the record as what was
run before.
...
DERIVED = 0.307831   # d131: the converged curvature-command constant (d38's Euler value was 0.306034)
...
def main():
    ...
    out['rows'] = rows
    json.dump(out, open(HERE / 'd133_relocate_nav2_converged_2026-09-23.json', 'w'), indent=2)
    print('\n-> d133_relocate_nav2_converged_2026-09-23.json')
    return 0
